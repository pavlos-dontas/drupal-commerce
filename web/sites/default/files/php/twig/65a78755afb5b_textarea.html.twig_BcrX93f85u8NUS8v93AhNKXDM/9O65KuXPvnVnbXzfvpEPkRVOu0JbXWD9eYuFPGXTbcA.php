...
class __TwigTemplate_15b9122278e6b7128cb328213d22b4fa extends Template
{
    private $source;
    private $macros = [];
  ...
  <textarea";
        // line 17
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["form-control"], "method", false, false, true, 17), 17, $this->source), "html", null, true);
        echo ">";
